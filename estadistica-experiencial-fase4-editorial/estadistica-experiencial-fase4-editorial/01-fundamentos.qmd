...
### bd S07D_Acuicultura.csv

La primera base de datos utilizada en este libro corresponde al **Tercer Censo Nacional Agropecuario (CNA) de Colombia, realizado en 2014**, específicamente a la subbase del **sector acuícola**, cuya información fue suministrada por el **Departamento Administrativo Nacional de Estadística (DANE)**. Esta fuente constituye un insumo oficial de carácter nacional que permite trabajar con datos reales asociados a la actividad productiva acuícola del país. Ver diccionario de variables en sitio web del DANE [Diccionario_S07D_Acuicultura](https://microdatos.dane.gov.co/index.php/catalog/513/data-dictionary/F4?file_name=S07D(Acuicultura))

### bd medidas antropométricas

La segunda base de datos corresponde a un conjunto de información antropométrica recopilada en estudiantes universitarios durante actividades académicas de la asignatura **Estadística Descriptiva y Probabilidad**, orientadas por el profesor **Miguel Oswaldo Pérez Pulido**. Esta base incluye variables relacionadas con el peso corporal, la estatura, la longitud de diferentes segmentos corporales, el índice de masa corporal (IMC) y otras medidas antropométricas de interés.

Esta base de datos fue construida a partir del **Taller de Clase No. 2: Práctica sobre Medidas Antropométricas**, desarrollado en el marco de la asignatura **Estadística Descriptiva y Probabilidad**, constituyéndose en un recurso didáctico para el aprendizaje experiencial de la estadística mediante el análisis de datos obtenidos por los propios estudiantes.
...
Fuente oficial: [DANE – Diccionario S07D Acuicultura](https://microdatos.dane.gov.co/index.php/catalog/513/data-dictionary/F4?file_name=S07D(Acuicultura))
